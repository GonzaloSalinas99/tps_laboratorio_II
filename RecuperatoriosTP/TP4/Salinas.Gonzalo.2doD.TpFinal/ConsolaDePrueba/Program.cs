...
namespace ConsolaDePrueba
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("Guarde en un archivo del escritorio la lista en formato de personas");

            //LogDB logDB = new LogDB("Server=DESKTOP-2HKT4SF\\SQLEXPRESS;Database=TP4;Trusted_Connection=True;MultipleActiveResultSets=true;");

            //logDB.InsertarInfoEnDB(listaPersonas);

            //logDB.Eliminar(a3);

            //listaPersonas = logDB.LeerLog();

            //foreach (Persona item in listaPersonas.Personas)
            //{
